...
class CertificatesCreatorGet(LoggedInTestCase):
    ...
    def test_template(self):
        self.assertTemplateUsed(
            self.response, 'certificates/certificate/generator.html')
...
class CertificatesCreatorBlankDataPost(LoggedInTestCase):
    def setUp(self):
        ...
        self.response = self.client.post(
            r('certificates:certificates-creator'), data)
...
class CertificatesCreatorPost(LoggedInTestCase):
    def setUp(self):
        ...
        data = dict(
            template=self.template.pk,
            certificates='[["18114439076", "Alan Turing", "Evento", "01/01/2018"]]',
        )
    ...
    def test_template(self):
        ...
        self.assertTemplateUsed(
            self.response, 'certificates/template/inspector.html')
    ...
    def test_create_certificate_attrs(self):
        ...
        self.assertEqual(
            {'NOME_EVENTO': 'Evento', 'DATA_EVENTO': '01/01/2018'}, certificate.fields)
    ...
    def test_create_participant_attrs(self):
        ...
        self.assertEqual('18114439076', participant.dni)
...
class CertificatesCreatorInvalidBlankValuesPost(LoggedInTestCase):
    ...
    def test_html_has_errors(self):
        self.assertContains(
            self.response, 'A tabela não pode conter valores em branco')
