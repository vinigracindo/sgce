...
class CertificateEvaluationFormTest(TestCase):
    def setUp(self):
        ...
        self.form = CertificateEvaluationForm(self.user)
        self.form_as_super_user = CertificateEvaluationForm(self.super_user)

    def test_form_has_fields(self):
        """Form must have one field"""
        expected = ['event', 'template']
