...
class Template(models.Model):
    ...
    backside_title = models.CharField(
        'título do verso', max_length=255, blank=True)
    ...
    title_color = models.CharField(
        'cor do título', max_length=10, choices=COLOR, default=BLACK)
    title_font_size = models.PositiveIntegerField(
        'tamanho da fonte do título', default=30)
    ...
    content_text_color = models.CharField(
        'cor do texto', max_length=10, choices=COLOR, default=BLACK)
    content_font_size = models.PositiveIntegerField(
        'tamanho da fonte do texto', default=12)
    ...
    footer_text_color = models.CharField(
        'cor do rodapé', max_length=10, choices=COLOR, default=BLACK)
    ...
    def template_fields(self):
        ...
        required_fields = ['NUMERO_DNI', 'NOME_COMPLETO']
        another_fields = re.findall(
            r'\b([A-Z]+_[A-Z]+)\b', remove_accents(self.content))
...
class Certificate(models.Model):
    ...
    def get_safe_content(self):
        ...
        content = content.replace('NOME_COMPLETO', self.participant.name).replace(
            'NUMERO_DNI', self.participant.dni)
